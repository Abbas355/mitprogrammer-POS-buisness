...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        //force https if app.url is https OR if request is secure (behind proxy like ngrok)
        $url = parse_url(config('app.url'));
        
        if ($url['scheme'] == 'https' || request()->secure() || request()->header('X-Forwarded-Proto') == 'https') {
