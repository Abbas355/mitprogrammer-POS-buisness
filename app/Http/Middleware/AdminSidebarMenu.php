...
class AdminSidebarMenu
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        Menu::create('admin-sidebar-menu', function ($menu) {
            ...
            //Shopify menu - show if module is installed
            $moduleUtil = new ModuleUtil;
            if ($moduleUtil->isModuleInstalled('Shopify') && auth()->user()->can('product.view')) {
                $menu->url(
                    action([\Modules\Shopify\Http\Controllers\ShopifyController::class, 'index']),
                    __('shopify::shopify.shopify'),
                    [
                        'icon' => '<svg xmlns="http://www.w3.org/2000/svg" class="tw-size-5 tw-shrink-0" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                            <path d="M14.622 13.661c-1.577 .047 -3.122 .378 -4.62 .838l-.622 -6.49l2.954 .06c.329 0 .655 .021 .975 .058c.411 .048 .813 .112 1.204 .19c1.41 .297 2.777 .88 3.848 1.774l.277 .245l-.332 4.379z"></path>
                            <path d="M10.996 13.75c-1.754 .008 -3.456 .18 -5.096 .508l-1.9 -19.758h8.707l-.074 1.654c.303 .08 .603 .166 .898 .26c2.246 .738 4.288 1.922 5.992 3.46c1.75 1.58 3.071 3.484 3.882 5.642l-1.476 .044c-.57 -.98 -1.242 -1.893 -2.008 -2.733c-1.444 -1.556 -3.12 -2.637 -4.938 -3.308c-.498 -.202 -1.008 -.378 -1.53 -.529l-.078 -.03l-.023 4.375c0 .741 .028 1.472 .08 2.192c.054 .756 .138 1.5 .252 2.232l-.622 6.49z"></path>
                        </svg>',
                        'active' => request()->segment(1) == 'shopify'
                    ]
                )->order(62);
            }
